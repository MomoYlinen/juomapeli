...
export const styles = StyleSheet.create({
  ...
  baseGameHeader: { flex: 1 },
  baseGame: { flex: 7 },
  colorGameContainer: { flex: 1, backgroundColor: "#FCFCFC" },
  colorGameHeader: { flex: 1 },
  colorGame: { flex: 7 },
  colorGameText: { flex: 7 },
  endGameContainer: { flex: 1, backgroundColor: "#FCFCFC" },
  endGameHeader: { flex: 1 },
  endGame: { flex: 7 },
  endGameOptions: { flex: 7 },
});
